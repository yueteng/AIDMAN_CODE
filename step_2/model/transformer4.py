...
class TokenAndPositionEmbedding0(layers.Layer):
    def __init__(self, max_rows, max_cols, embed_dim,  **kwargs):
        ...
        self.max_cols = max_cols
        self.embed_dim = embed_dim
        super(TokenAndPositionEmbedding0, self).__init__()
    ...
    def build(self, input_shape):
        ...
        super(TokenAndPositionEmbedding0, self).build(input_shape)
    ...
    def get_config(self):
        ...
        base_config = super(TokenAndPositionEmbedding0, self).get_config()
        return {**base_config, **config}
...
get_custom_objects().update({
    ...
    'TokenAndPositionEmbedding0': TokenAndPositionEmbedding0
})
